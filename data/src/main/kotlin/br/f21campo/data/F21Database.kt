...
@Database(entities = [ProjectEntity::class, StationEntity::class, ReferencePointEntity::class, OccupationEntity::class, OccupationArtifactEntity::class, OccupationEventEntity::class, HeightMeasurementEntity::class], version = 11, exportSchema = true)
